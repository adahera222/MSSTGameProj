...
//	static bool DISABLE_ENEMY_ATTACK = false;
	...
	public static bool SHOW_GIZMOS = false;
	public static Vector2 INVALID_POSITIONV2 = new Vector2( -999, -999 );// new Vector2( 0, 330 ); //Vector2.zero;// new Vector2( -9999, -9999 );
	...
	static public Vector2 PLAYER_MOVABLE_BOUND_DOWNLEFT
	{ get { return -PLAYER_MOVABLE_BOUND_SIZE/2; } }

	static public Vector2 PLAYER_MOVABLE_BOUND_TOPRIGHT
	{ get { return PLAYER_MOVABLE_BOUND_SIZE/2; } }
